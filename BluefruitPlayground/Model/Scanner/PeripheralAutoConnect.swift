...
class PeripheralAutoConnect {
    ...
    // Data
    private var matchingPeripherals: [(blePeripheral: BlePeripheral, discoverTime: TimeInterval)] = []      // List of peripherals that could be selected, and time since they have been matching the requirements
